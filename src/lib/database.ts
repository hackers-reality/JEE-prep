...
const SCHEMA_STATEMENTS = [
  ...
  `CREATE TABLE IF NOT EXISTS "Student" ("id" TEXT NOT NULL PRIMARY KEY, "name" TEXT, "onboardingComplete" BOOLEAN NOT NULL DEFAULT false, "prepStage" TEXT, "jeeTarget" TEXT, "preferredDailyHours" INTEGER, "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME NOT NULL)`,
  ...
  `CREATE INDEX IF NOT EXISTS "StudySession_studentId_startedAt_idx" ON "StudySession"("studentId", "startedAt")`,
